...
import generated.LegoSorter_pb2 as LegoSorter__pb2
...
class LegoSorterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.processNextImageAsync = channel.unary_unary(
                '/sorter.LegoSorter/processNextImageAsync',
                request_serializer=Messages__pb2.ImageRequest.SerializeToString,
...
class LegoSorterServicer(object):
    ...
    def processNextImageAsync(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_LegoSorterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'processNextImageAsync': grpc.unary_unary_rpc_method_handler(
                    servicer.processNextImageAsync,
                    request_deserializer=Messages__pb2.ImageRequest.FromString,
...
class LegoSorter(object):
    ...
    @staticmethod
    def processNextImageAsync(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sorter.LegoSorter/processNextImageAsync',
            Messages__pb2.ImageRequest.SerializeToString,
